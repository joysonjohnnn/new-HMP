...
!(function () {
  ...
  const a = document.querySelector("#orderChart"),
    n = {
      chart: {
        height: 80,
        type: "area",
  ...
  if (void 0 !== typeof a && null !== a) {
    new ApexCharts(a, n).render();
  }
  const l = document.querySelector("#totalRevenueChart"),
    d = {
      series: [
      ...
      yaxis: { labels: { style: { fontSize: "13px", colors: t } } },
      responsive: [
        {
          breakpoint: 1700,
          options: {
            plotOptions: { bar: { borderRadius: 10, columnWidth: "32%" } },
          },
        },
        {
          breakpoint: 1580,
        ...
        },
        {
          breakpoint: 1040,
          options: {
            plotOptions: { bar: { borderRadius: 11, columnWidth: "48%" } },
          },
        },
        {
          breakpoint: 991,
          options: {
            plotOptions: { bar: { borderRadius: 10, columnWidth: "30%" } },
          },
        },
        {
          breakpoint: 840,
        ...
        },
        {
          breakpoint: 768,
          options: {
            plotOptions: { bar: { borderRadius: 10, columnWidth: "28%" } },
          },
        },
        {
          breakpoint: 640,
        ...
        },
        {
          breakpoint: 576,
          options: {
            plotOptions: { bar: { borderRadius: 10, columnWidth: "37%" } },
          },
        },
        {
          breakpoint: 480,
  ...
  if (void 0 !== typeof l && null !== l) {
    new ApexCharts(l, d).render();
  }
  const c = document.querySelector("#growthChart"),
    p = {
      series: [78],
      labels: ["Growth"],
  ...
  if (void 0 !== typeof c && null !== c) {
    new ApexCharts(c, p).render();
  }
  const h = document.querySelector("#revenueChart"),
    f = {
  ...
  if (void 0 !== typeof h && null !== h) {
    new ApexCharts(h, f).render();
  }
  const b = document.querySelector("#profileReportChart"),
    u = {
      chart: {
        height: 80,
        type: "line",
  ...
  if (void 0 !== typeof b && null !== b) {
    new ApexCharts(b, u).render();
  }
  const g = document.querySelector("#orderStatisticsChart"),
    y = {
  ...
  if (void 0 !== typeof g && null !== g) {
    new ApexCharts(g, y).render();
  }
  const m = document.querySelector("#incomeChart"),
    w = {
  ...
  if (void 0 !== typeof m && null !== m) {
    new ApexCharts(m, w).render();
  }
  const k = document.querySelector("#expensesOfWeek"),
    x = {
      series: [65],
