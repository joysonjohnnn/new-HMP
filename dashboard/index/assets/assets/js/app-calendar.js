    ...
    !(function () {
      ...
      function M() {
        ...
        e.setAttribute("data-bs-toggle", "sidebar"),
          ...
          e.insertAdjacentHTML(
            "beforeend",
            '<i class="bx bx-menu bx-sm text-body"></i>'
          );
      }
      ...
      let T = new Calendar(e, {
        ...
        eventClick: function (e) {
          !(function (e) {
            (E = e.event),
              E.url &&
                (e.jsEvent.preventDefault(), window.open(E.url, "_blank")),
              q.show(),
              ...
              void 0 !== E.extendedProps.description &&
                (b.value = E.extendedProps.description);
          })(e);
        },
        datesSet: function () {
          M();
      ...
      d.addEventListener("click", (e) => {
        ...
        k.config.onChange.push(function (e) {
          T.changeView(T.view.type, moment(e[0]).format("YYYY-MM-DD")),
            M(),
            t.classList.remove("show"),
            a.classList.remove("show");
        });
